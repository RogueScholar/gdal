...
png_fixed_point PNGAPI png_get_pixel_aspect_ratio_fixed(
...
static png_uint_32 ppi_from_ppm(png_uint_32 ppm) {
  ...
  if (ppm <= PNG_UINT_31_MAX &&
      png_muldiv(&result, (png_int_32)ppm, 127, 5000) != 0)
...
png_fixed_point PNGAPI png_get_x_offset_inches_fixed(
    png_const_structrp png_ptr, png_const_inforp info_ptr) {
  return png_fixed_inches_from_microns(
      png_ptr, png_get_x_offset_microns(png_ptr, info_ptr));
}
#endif

#ifdef PNG_FIXED_POINT_SUPPORTED
png_fixed_point PNGAPI png_get_y_offset_inches_fixed(
    png_const_structrp png_ptr, png_const_inforp info_ptr) {
  return png_fixed_inches_from_microns(
      png_ptr, png_get_y_offset_microns(png_ptr, info_ptr));
}
#endif
...
png_uint_32 PNGAPI png_get_bKGD(png_const_structrp png_ptr, png_inforp info_ptr,
  ...
  if (png_ptr != NULL && info_ptr != NULL &&
      (info_ptr->valid & PNG_INFO_bKGD) != 0 && background != NULL) {
...
png_uint_32 PNGAPI png_get_cHRM(png_const_structrp png_ptr,
  ...
  if (png_ptr != NULL && info_ptr != NULL &&
    ...
    if (white_x != NULL)
      *white_x = png_float(png_ptr, info_ptr->colorspace.end_points_xy.whitex,
                           "cHRM white X");
    if (white_y != NULL)
      *white_y = png_float(png_ptr, info_ptr->colorspace.end_points_xy.whitey,
                           "cHRM white Y");
    if (red_x != NULL)
    ...
    if (red_y != NULL)
      *red_y = png_float(png_ptr, info_ptr->colorspace.end_points_xy.redy,
                         "cHRM red Y");
    if (green_x != NULL)
      *green_x = png_float(png_ptr, info_ptr->colorspace.end_points_xy.greenx,
                           "cHRM green X");
    if (green_y != NULL)
      *green_y = png_float(png_ptr, info_ptr->colorspace.end_points_xy.greeny,
                           "cHRM green Y");
    if (blue_x != NULL)
  ...
  if (png_ptr != NULL && info_ptr != NULL &&
    ...
    if (red_Z != NULL)
      *red_Z = png_float(png_ptr, info_ptr->colorspace.end_points_XYZ.red_Z,
                         "cHRM red Z");
    if (green_X != NULL)
      *green_X = png_float(png_ptr, info_ptr->colorspace.end_points_XYZ.green_X,
                           "cHRM green X");
    if (green_Y != NULL)
      *green_Y = png_float(png_ptr, info_ptr->colorspace.end_points_XYZ.green_Y,
                           "cHRM green Y");
    if (green_Z != NULL)
      *green_Z = png_float(png_ptr, info_ptr->colorspace.end_points_XYZ.green_Z,
                           "cHRM green Z");
    if (blue_X != NULL)
...
png_uint_32 PNGAPI png_get_cHRM_fixed(
    png_const_structrp png_ptr, png_const_inforp info_ptr,
...
png_uint_32 PNGAPI png_get_gAMA(png_const_structrp png_ptr,
  ...
  if (png_ptr != NULL && info_ptr != NULL &&
      ...
      file_gamma != NULL) {
    *file_gamma =
        png_float(png_ptr, info_ptr->colorspace.gamma, "png_get_gAMA");
    return (PNG_INFO_gAMA);
  }
...
png_uint_32 PNGAPI png_get_iCCP(png_const_structrp png_ptr, png_inforp info_ptr,
  ...
  if (png_ptr != NULL && info_ptr != NULL &&
      (info_ptr->valid & PNG_INFO_iCCP) != 0 && name != NULL &&
...
png_uint_32 PNGAPI png_get_eXIf(png_const_structrp png_ptr, png_inforp info_ptr,
                                png_bytep *exif) {
...
png_uint_32 PNGAPI png_get_eXIf_1(png_const_structrp png_ptr,
                                  png_const_inforp info_ptr,
...
png_uint_32 PNGAPI png_get_IHDR(png_const_structrp png_ptr,
                                png_const_inforp info_ptr, png_uint_32 *width,
...
png_uint_32 PNGAPI png_get_oFFs(png_const_structrp png_ptr,
  ...
  if (png_ptr != NULL && info_ptr != NULL &&
      (info_ptr->valid & PNG_INFO_oFFs) != 0 && offset_x != NULL &&
...
png_uint_32 PNGAPI png_get_pCAL(png_const_structrp png_ptr, png_inforp info_ptr,
  ...
  if (png_ptr != NULL && info_ptr != NULL &&
      (info_ptr->valid & PNG_INFO_pCAL) != 0 && purpose != NULL && X0 != NULL &&
