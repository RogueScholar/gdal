 ...
 */
void PNGAPI png_set_filler(png_structrp png_ptr, png_uint_32 filler,
                           int filler_loc) {
  ...
  else /* write */
  {
    ...
    case PNG_COLOR_TYPE_GRAY:
      if (png_ptr->bit_depth >= 8) {
         ...
         * size!
         */
        png_app_error(png_ptr, "png_set_filler is invalid for"
...
void PNGAPI png_set_add_alpha(png_structrp png_ptr, png_uint_32 filler,
                              int filler_loc) {
