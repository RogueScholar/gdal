...
PNG_FUNCTION(png_structp, PNGAPI png_create_read_struct,
             (png_const_charp user_png_ver, png_voidp error_ptr,
              png_error_ptr error_fn, png_error_ptr warn_fn),
             PNG_ALLOCATED) {
#ifndef PNG_USER_MEM_SUPPORTED
  png_structp png_ptr = png_create_png_struct(user_png_ver, error_ptr, error_fn,
...
PNG_FUNCTION(png_structp, PNGAPI png_create_read_struct_2,
             ...
             PNG_ALLOCATED) {
  png_structp png_ptr = png_create_png_struct(
...
void PNGAPI png_read_update_info(png_structrp png_ptr, png_inforp info_ptr) {
  ...
  if (png_ptr != NULL) {
    ...
    /* New in 1.6.0 this avoids the bug of doing the initializations twice */
      ...
      png_app_error(
          png_ptr, "png_read_update_info/png_start_read_image: duplicate call");
  }
}
...
void PNGAPI png_start_read_image(png_structrp png_ptr) {
  ...
  if (png_ptr != NULL) {
    ...
    /* New in 1.6.0 this avoids the bug of doing the initializations twice */
      ...
      png_app_error(
          png_ptr, "png_start_read_image/png_read_update_info: duplicate call");
  }
}
#endif /* SEQUENTIAL_READ */
...
void PNGAPI png_read_png(png_structrp png_ptr, png_inforp info_ptr,
  ...
  if (info_ptr->row_pointers == NULL) {
    ...
    info_ptr->row_pointers =
        png_voidcast(png_bytepp, png_malloc(png_ptr, info_ptr->height *
                                                         (sizeof(png_bytep))));
    ...
    for (iptr = 0; iptr < info_ptr->height; iptr++)
      info_ptr->row_pointers[iptr] =
          png_voidcast(png_bytep, png_malloc(png_ptr, info_ptr->rowbytes));
  }
...
static int png_image_read_init(png_imagep image) {
  if (image->opaque == NULL) {
    png_structp png_ptr = png_create_read_struct(
        PNG_LIBPNG_VER_STRING, image, png_safe_error, png_safe_warning);
    ...
    if (png_ptr != NULL) {
      ...
      if (info_ptr != NULL) {
        png_controlp control = png_voidcast(
            png_controlp, png_malloc_warn(png_ptr, (sizeof *control)));
  ...
  if (image != NULL && image->version == PNG_IMAGE_VERSION) {
    if (file != NULL) {
      ...
      return png_image_error(
          image, "png_image_begin_read_from_stdio: invalid argument");
  }

  else if (image != NULL)
    return png_image_error(
        image, "png_image_begin_read_from_stdio: incorrect PNG_IMAGE_VERSION");
...
int PNGAPI png_image_begin_read_from_file(png_imagep image,
  ...
  if (image != NULL && image->version == PNG_IMAGE_VERSION) {
    if (file_name != NULL) {
      ...
      return png_image_error(
          image, "png_image_begin_read_from_file: invalid argument");
  }

  else if (image != NULL)
    return png_image_error(
        image, "png_image_begin_read_from_file: incorrect PNG_IMAGE_VERSION");

  return 0;
}
#endif /* STDIO */

static void PNGCBAPI png_image_memory_read(png_structp png_ptr, png_bytep out,
                                           size_t need) {
  if (png_ptr != NULL) {
...
int PNGAPI png_image_begin_read_from_memory(png_imagep image,
  ...
  if (image != NULL && image->version == PNG_IMAGE_VERSION) {
    if (memory != NULL && size > 0) {
      ...
      return png_image_error(
          image, "png_image_begin_read_from_memory: invalid argument");
  }

  else if (image != NULL)
    return png_image_error(
        image, "png_image_begin_read_from_memory: incorrect PNG_IMAGE_VERSION");
...
static unsigned int decode_gamma(png_image_read_control *display,
                                 png_uint_32 value, int encoding) {
...
static void png_create_colormap_entry(png_image_read_control *display,
                                      png_uint_32 ip, png_uint_32 red,
                                      png_uint_32 green, png_uint_32 blue,
                                      png_uint_32 alpha, int encoding) {
  png_imagep image = display->image;
  int output_encoding =
      (image->format & PNG_FORMAT_FLAG_LINEAR) != 0 ? P_LINEAR : P_sRGB;
...
static int png_image_read_colormap(png_voidp argument) {
  ...
  int output_encoding =
      (output_format & PNG_FORMAT_FLAG_LINEAR) != 0 ? P_LINEAR : P_sRGB;
        ...
        if ((output_format & PNG_FORMAT_FLAG_ALPHA) != 0)
          ...
          if (back_r == back_g && back_g == back_b) {
            ...
            if (output_encoding == P_LINEAR) {
               ...
               * matches.
               */
              png_create_colormap_entry(display, gray, back_g, back_g, back_g,
                                        65535, P_LINEAR);
            }
            ...
            png_set_background_fixed(png_ptr, &c, PNG_BACKGROUND_GAMMA_SCREEN,
                                     0 /*need_expand*/, 0 /*gamma: not used*/);
    ...
    else /* alpha is removed */
    {
      ...
      if ((output_format & PNG_FORMAT_FLAG_COLOR) == 0 ||
        ...
        while (i < 231) {
          ...
          png_create_colormap_entry(display, i++, gray, gray, gray, 255,
                                    P_sRGB);
        }
        ...
        for (a = 1; a < 5; ++a) {
          ...
          for (g = 0; g < 6; ++g) {
            ...
            png_create_colormap_entry(
                display, i++, PNG_sRGB_FROM_LINEAR(gray + back_rx),
        ...
        if (png_ptr->color_type == PNG_COLOR_TYPE_RGB_ALPHA ||
          ...
          if (data_encoding == P_FILE) /* from the fixup above */
          {
            ...
            gray = PNG_DIV257(png_gamma_16bit_correct(
                gray, png_ptr->colorspace.gamma)); /* now P_FILE */
    ...
    else /* output is color */
    {
      ...
      if (png_ptr->color_type == PNG_COLOR_TYPE_RGB_ALPHA ||
        ...
        if ((output_format & PNG_FORMAT_FLAG_ALPHA) != 0) {
          ...
          png_create_colormap_entry(display, cmap_entries, 255, 255, 255, 0,
                                    P_sRGB);
          ...
          for (r = 0; r < 256; r = (r << 1) | 0x7f) {
            ...
            for (g = 0; g < 256; g = (g << 1) | 0x7f) {
              ...
              for (b = 0; b < 256; b = (b << 1) | 0x7f)
                png_create_colormap_entry(display, cmap_entries++, r, g, b, 128,
                                          P_sRGB);
            }
          }
          ...
          png_create_colormap_entry(display, cmap_entries, back_r, back_g,
                                    back_b, 0 /*unused*/, output_encoding);
              ...
              for (g = 0; g < 256; g = (g << 1) | 0x7f) {
                ...
                for (b = 0; b < 256; b = (b << 1) | 0x7f)
                  png_create_colormap_entry(
                      ...
                      png_colormap_compose(display, r, P_sRGB, 128, back_r,
                                           output_encoding),
                      png_colormap_compose(display, g, P_sRGB, 128, back_g,
                                           output_encoding),
                      png_colormap_compose(display, b, P_sRGB, 128, back_b,
                                           output_encoding),
                      0 /*unused*/, output_encoding);
              }
            }
  ...
  case PNG_COLOR_TYPE_PALETTE:
     ...
     */
    {
      ...
      int do_background =
          trans != NULL && (output_format & PNG_FORMAT_FLAG_ALPHA) == 0;
      unsigned int i;
      ...
      for (i = 0; i < cmap_entries; ++i) {
        if (do_background != 0 && i < num_trans && trans[i] < 255) {
          if (trans[i] == 0)
            png_create_colormap_entry(display, i, back_r, back_g, back_b, 0,
                                      output_encoding);
            ...
            png_create_colormap_entry(
                display, i,
                png_colormap_compose(display, colormap[i].red, P_FILE, trans[i],
          ...
          png_create_colormap_entry(
              display, i, colormap[i].red, colormap[i].green, colormap[i].blue,
     ...
     */
    {
      ...
      for (pass = 0; pass < passes; ++pass) {
        ...
        for (; y < height; y += stepy) {
          ...
          /* Read the row, which is packed: */
          png_read_row(png_ptr, png_voidcast(png_bytep, display->local_row),
                       NULL);
      ...
      if (image->opaque != NULL && buffer != NULL && check >= png_row_stride) {
        ...
        if (image->height <= 0xffffffffU /
          ...
          if ((image->format & PNG_FORMAT_FLAG_COLORMAP) == 0 ||
            ...
            return png_image_error(
                image, "png_image_finish_read[color-map]: no color-map");
        }
