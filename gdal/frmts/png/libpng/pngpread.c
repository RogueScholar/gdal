...
png_uint_32 PNGAPI png_process_data_skip(png_structrp png_ptr) {
   ...
   */
  png_app_warning(png_ptr, "png_process_data_skip is not implemented in any "
...
void PNGCBAPI png_push_fill_buffer(png_structp png_ptr, png_bytep buffer,
                                   size_t length) {
  png_bytep ptr;
  ...
  */
  ...
  if (png_ptr->interlaced != 0) {
    ...
    do {
      ...
      png_ptr->num_rows = (png_ptr->height + png_pass_yinc[png_ptr->pass] - 1 -
